...
from temporal_abstraction.discretization.methods.td4c_persist.td4c import TD4CKullbackLeibler, TD4CEntropy, \
    TD4CEntropyIG, TD4CCosine, TD4CDiffSum, TD4CDiffMax
...
class AbstractionPerProperty:
    ...
    def __generate_abstraction_by_name(params_row, entity_class_relations=None, states=None):
        ...
        dispatch = {
            ...
            MethodsNames.TD4CEntropyIG: TD4CEntropyIG,
            MethodsNames.TD4CKullbackLeibler: TD4CKullbackLeibler,
            MethodsNames.TD4CDiffSum: TD4CDiffSum,
            MethodsNames.TD4CDiffMax: TD4CDiffMax,
